...
public class UnivariateRegressionProblemOLD<F extends UnivariateRegressionFitnessOLD> implements ComparableQualityBasedProblem<NamedUnivariateRealFunction, Double>, ProblemWithValidation<NamedUnivariateRealFunction, Double>, ProblemWithExampleSolution<NamedUnivariateRealFunction> {

  private final F fitness;
  private final F validationFitness;

  public UnivariateRegressionProblemOLD(F fitness, F validationFitness) {
