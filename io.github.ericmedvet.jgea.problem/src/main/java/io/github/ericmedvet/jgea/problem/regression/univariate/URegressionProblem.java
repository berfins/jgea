...
public interface URegressionProblem extends SimpleEBMOProblem<NamedUnivariateRealFunction, Map<String, Double>,
    Double, URegressionProblem.Outcome, Double>, ProblemWithExampleSolution<NamedUnivariateRealFunction> {
