...
public class Representations {
  ...
  public static Function<Network, Representation<Network>> ttpn(
      ...
      @Param(value = "gates", dNPMs = {"ea.ttpn.gate.bAnd()", "ea.ttpn.gate.bNot()", "ea.ttpn.gate.bOr()",
          ...
          ".splitter()", "ea" + ".ttpn.gate.unpairer()", "ea" + ".ttpn.gate.iBefore()", "ea.ttpn.gate.iPMathOperator" +
          "(operator = addition)", "ea.ttpn.gate.iPMathOperator" + "(operator = subtraction)", "ea.ttpn.gate" +
          ".iPMathOperator(operator = " + "multiplication)", "ea.ttpn.gate" + ".iPMathOperator(operator = division)",
          "ea.ttpn.gate.iRange()", "ea" + ".ttpn.gate.iSMult()", "ea.ttpn.gate" + ".iSPMult()", "ea.ttpn.gate.iSPSum" +
          "()", "ea.ttpn.gate.iSSum()", "ea" + ".ttpn.gate.iToR()", "ea.ttpn.gate.rBefore" + "()", "ea.ttpn.gate" +
          ".repeater()", "ea.ttpn.gate.rPMathOperator" + "(operator = addition)", "ea.ttpn.gate" + ".rPMathOperator" +
          "(operator = subtraction)", "ea.ttpn.gate" + ".rPMathOperator(operator = multiplication)", "ea" + ".ttpn" +
          ".gate.rPMathOperator(operator = division)", "ea" + ".ttpn.gate.rSMult()", "ea.ttpn.gate.rSPMult()",
          "ea" + ".ttpn.gate.rSPSum()", "ea.ttpn.gate.rSSum()", "ea" + ".ttpn.gate.rToI()", "ea.ttpn.gate.sBefore()",
          "ea.ttpn" + ".gate.sConcat()", "ea.ttpn.gate.sSplitter()", "ea.ttpn.gate.bConst(value = true)", "ea.ttpn" +
          ".gate.iConst" + "(value = 0)", "ea.ttpn.gate.iConst(value = 1)", "ea.ttpn.gate.iConst(value = 2)", "ea" +
          ".ttpn.gate.iConst" + "(value = 5)", "ea.ttpn.gate.rConst(value = 0)", "ea.ttpn.gate.rConst(value = 0.1)",
          "ea.ttpn.gate.rConst" + "(value = 0.2)", "ea.ttpn.gate.rConst(value =" + " 0.5)"}) List<Gate> gates,
